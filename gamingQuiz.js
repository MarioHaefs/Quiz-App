function startGamingQuiz() {
    ...
    content.innerHTML = '';
    changeInnerContent();
    content.innerHTML += startGamingQuizHTML();
    showGamingQuestion();

    let hideArrow = document.getElementById('arrows')
    hideArrow.classList.add("hide");
    let showArrow = document.getElementById('gaming-arrows')
    showArrow.classList.remove('hide');
}


function startGamingQuizHTML() {
    return /*html*/ `
    <div class="question-card">
        <h5 id="question-text"></h5>
         <div onclick="gamingAnswer('answer_1')" id="answer_1" class="abcd">
            <span id="A" class="letter-box">A</span>
            <span id="answer-1" class="answer"></span>
        </div>
         <div onclick="gamingAnswer('answer_2')" id="answer_2" class="abcd">
            <span id="B" class="letter-box">B</span>
            <span id="answer-2" class="answer"></span>
        </div>
         <div onclick="gamingAnswer('answer_3')" id="answer_3" class="abcd">
            <span id="C" class="letter-box">C</span>
            <span id="answer-3" class="answer"></span>
        </div>
         <div onclick="gamingAnswer('answer_4')" id="answer_4" class="abcd">
            <span id="D" class="letter-box">D</span>
            <span id="answer-4" class="answer"></span>
        </div>  
        <span>Du hast <b id="question-number">${number}</b> von <b>${gaming.length}</b> Fragen beantwortet.</span>
        <div class="progress">
...
function showGamingQuestion() {
    let question = gaming[currentQuestion];
...
function gamingAnswer(selection) {
    let question = gaming[currentQuestion];
